...
class Block(nn.Module):
    def __init__(self, n_ctx, config, scale=False, perturbation=False, bottleneck=0):
...
# class AdapterAtten(nn.Module):
#     def __init__(self, config, bottleneck):
#         super(AdapterAtten, self).__init__()
#         nx = config.n_embd
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    """
    def __init__(self, config, perturbation_layers, bottleneck): 
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def forward(self, input_ids, position_ids=None, token_type_ids=None, labels=None, past=None, head_mask=None, self_copy=False):
