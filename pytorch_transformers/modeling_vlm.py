...
class Attention(nn.Module):
    def __init__(self, nx, n_ctx, config, scale=False, bottleneck=0):
...
class Block(nn.Module):
    def __init__(self, n_ctx, config, scale=False, bottleneck_map=None):
...
class MixAdapter(nn.Module):
    def __init__(self, config, bottleneck_map):
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    """
    def __init__(self, config, bottleneck_map=None): 
    ...
    def forward(self, input_ids, position_ids=None, token_type_ids=None, past=None, head_mask=None, task_id=-1):
        if past is None:
            past_length = 0
...
class VLM(GPT2PreTrainedModel):
    ...
    def forward(self, input_ids, position_ids=None, token_type_ids=None, labels=None, past=None, head_mask=None, self_copy=False, task_id=-1):
